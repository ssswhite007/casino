...
<a
	class="{!load
		? 'hidden'
		: ''} border-b-4 border-b-transparent group flex flex-col bg-white dark:bg-white5 relative w-full rounded-[20px] overflow-hidden hover:border-b-blue transition-all"
>
	...
	<div class="w-full flex gap-[6px] items-center justify-between px-[13px] pt-[11px] pb-[8px]">
